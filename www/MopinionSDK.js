 ...
 * @param callback success callback, will be called from native side
 * @param errorCallback may be called in case of error, .i.e. when loading failed
 * @returns response details JSON Object with the following parameters:
 ...
 * @param callback success callback, is always called unless an error occurred
 * @param errorCallback may be called in case of error
 * @returns the response details as JSON Object with the following parameters:
